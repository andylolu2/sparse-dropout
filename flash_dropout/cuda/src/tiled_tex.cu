...
template <class AtomLayoutMNK, class ValLayoutMNK, class PermutationsMNK, class LayoutC,
          class ThrIDC, class LayoutA, class ThrIDA, class LayoutB, class ThrIDB>
void print_mma(const char* name, const AtomLayoutMNK& atom_layout_mnk,
               const ValLayoutMNK& val_layout_mnk, const PermutationsMNK& permutations_mnk,
               LayoutC const& C,
    ...
    printf(
        "\\begin{adjustbox}{max height=0.7\\textheight,max "
        "width=\\textwidth}%");
    printf(
    ...
    for (int m = 0; m < size<0>(C); ++m) {
        for (int n = 0; n < size<1>(C); ++n) {
            ...
            printf(
                "\\node[box,fill=%s] at (%d,%d) {\\shortstack{T%d \\\\ "
                "V%d}};\n",
...
template <class TiledCopy, class LayoutS, class ThrIDS, class LayoutD, class ThrIDD>
...
template <class MMA_Atom_Arch, class AtomLayoutMNK, class ValLayoutMNK, class PermutationsMNK>
void print_mma_content(
    ...
    print_mma(name, AtomLayoutMNK{}, ValLayoutMNK{}, PermutationsMNK{}, layoutC_MN, thrID_C,
              layoutA_MK, thrID_A, layoutB_NK, thrID_B);
}
...
void print_layouts_for_mma() {
    ...
    //     print_mma_content("SM70_8x8x4_F32F16F16F32_NT", tiled_mma);
    // }

    // {
    //     auto tiled_mma =
    //         make_tiled_mma(SM75_16x8x8_F32F16F16F32_TN{}, Layout<Shape<_1, _2>>{}  //
    //         AtomLayoutMNK
    //         );
    //     print_mma_content("SM70_8x8x4_F32F16F16F32_NT", tiled_mma);
    // }
    ...
    // {
    //     auto tiled_mma =
    //         make_tiled_mma(SM75_16x8x8_F32F16F16F32_TN{}, Layout<Shape<_2, _1>>{}  //
    //         AtomLayoutMNK
    //         );
    //     print_mma_content("SM70_8x8x4_F32F16F16F32_NT", tiled_mma);
    // }
    ...
    // {
    //     auto tiled_mma =
    //         make_tiled_mma(SM75_16x8x8_F32F16F16F32_TN{}, Layout<Shape<_2, _2>>{}  //
    //         AtomLayoutMNK
    //         );
    //     print_mma_content("SM70_8x8x4_F32F16F16F32_NT", tiled_mma);
    // }
    ...
    //                                     Layout<Shape<_1, _1>>{}       // ValLayoutMNK
    //     );
    //     print_mma_content("SM70_8x8x4_F32F16F16F32_NT", tiled_mma);
    // }
    ...
    // {
    //     auto tiled_mma =
    //         make_tiled_mma(SM75_16x8x8_F32F16F16F32_TN{}, Layout<Shape<_1, _1>>{},  //
    //         AtomLayoutMNK
    ...
    //                                   Layout<Shape<_2,_2>>{},        // 2x2
    //                                   layout of atoms (threads)
    //                                   Layout<Shape<_1,_1>>{},        // 1x1
    //                                   layout of atoms (values)
...
void print_layouts_for_sm80_cp_async_cachealways() {
    ...
    {
        auto tiled_mma = make_tiled_mma(SM75_16x8x8_F32F16F16F32_TN{});
        auto copy_atom = Copy_Atom<SM75_U32x1_LDSM_N, half_t>{};
        auto tiled_copy = make_tiled_copy_A(copy_atom, tiled_mma);
        print_copy_content("SM75_U32x1_LDSM_N", tiled_copy);
    }

    {
        auto tiled_mma = make_tiled_mma(SM75_16x8x8_F32F16F16F32_TN{},
                                        make_layout(make_shape(_1{}, _1{}, _2{})));
        auto copy_atom = Copy_Atom<SM75_U32x2_LDSM_N, half_t>{};
        auto tiled_copy = make_tiled_copy_A(copy_atom, tiled_mma);
        print_copy_content("SM75_U32x2_LDSM_N", tiled_copy);
    }

    // {
    //     auto tiled_mma = make_tiled_mma(SM75_16x8x8_F32F16F16F32_TN{});
    //     auto copy_atom = Copy_Atom<SM75_U32x4_LDSM_N, half_t>{};
    //     auto tiled_copy = make_tiled_copy_A(copy_atom, tiled_mma);
    //     print_copy_content("SM75_U32x4_LDSM_N", tiled_copy);
    // }

    {
        auto tiled_mma = make_tiled_mma(SM75_16x8x8_F32F16F16F32_TN{});
        auto copy_atom = Copy_Atom<SM75_U16x2_LDSM_T, half_t>{};
        auto tiled_copy = make_tiled_copy_A(copy_atom, tiled_mma);
        print_copy_content("SM75_U16x2_LDSM_T", tiled_copy);
    }

    // {
    //     using ST = float;
    //     using DT = float;
    //     using Copy_Atom_Arch = Copy_Atom<Copy_Traits<SM75_16x8x8_F32F16F16F32_TN>, DT>;
    //     auto tiled_copy =
    //         TiledCopy<Copy_Atom_Arch, Layout<Shape<_32, _1>>, Layout<Shape<_4, _8>>>{};
    ...
    //     using ST = float;
    //     using DT = float;
    //     using Copy_Atom_Arch = Copy_Atom<Copy_Traits<SM75_U16x2_LDSM_T>, DT>;
    //     auto tiled_copy = TiledCopy<Copy_Atom_Arch, Layout<Shape<_2, _1>>, Layout<Shape<_8,
    //     _4>>>{}; print_copy_content("SM80_CP_ASYNC_CACHEALWAYS", tiled_copy);
    // }
    ...
    //     auto tiled_copy =
    //         TiledCopy<Copy_Atom_Arch, Layout<Shape<_16, _1>>, Layout<Shape<_8, _8>>>{};
    //     print_copy_content("SM80_CP_ASYNC_CACHEALWAYS", tiled_copy);
    // }
    ...
    //     using Copy_Atom_Arch = Copy_Atom<Copy_Traits<SM80_CP_ASYNC_CACHEALWAYS<ST, DT>>, DT>;
    //     auto tiled_copy =
    //         TiledCopy<Copy_Atom_Arch, Layout<Shape<_32, _1>>, Layout<Shape<_8, _8>>>{};
    //     print_copy_content("SM80_CP_ASYNC_CACHEALWAYS", tiled_copy);
    // }
    ...
    //     using DT = float;
    //     using Copy_Atom_Arch = Copy_Atom<Copy_Traits<SM80_CP_ASYNC_CACHEALWAYS<ST, DT>>, DT>;
    //     auto tiled_copy = TiledCopy<Copy_Atom_Arch, Layout<Shape<_4, _4>>, Layout<Shape<_8,
    //     _8>>>{}; print_copy_content("SM80_CP_ASYNC_CACHEALWAYS", tiled_copy);
    // }
    ...
    //     using DT = float;
    //     using Copy_Atom_Arch = Copy_Atom<Copy_Traits<SM80_CP_ASYNC_CACHEALWAYS<ST, DT>>, DT>;
    //     auto tiled_copy = TiledCopy<Copy_Atom_Arch, Layout<Shape<_4, _1>>,
